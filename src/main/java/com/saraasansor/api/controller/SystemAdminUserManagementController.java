...
public class SystemAdminUserManagementController {
    ...
    public ResponseEntity<ApiResponse<List<ManagedUserResponse>>> getTenantUsers(@PathVariable Long tenantId) {
        return ResponseEntity.ok(ApiResponse.success(userManagementService.getTenantUsersForPlatform(tenantId)));
    }
