...
public class FeatureService {
    ...
    public Set<String> getEnabledFeatures(Long tenantId) {
        ...
        if(tenantFeatureOverrideList == null || tenantFeatureOverrideList.isEmpty()) return Collections.emptySet();

        List<Feature> features = tenantFeatureOverrideList.stream().map(TenantFeatureOverride::getFeature).toList();
